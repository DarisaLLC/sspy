...
def compute_selfsimilarity(content_path, q_size=-1, content_prefix='image', content_format='*.jpg'):
    ...
    if(q_size == len(files)):
        plotAndShow(ssm, ss[0,:])
    else:
        plotAndShow(ssm, sotime)
...
if __name__ == '__main__':
    ...
    compute_selfsimilarity(sys.argv[1], duration)
